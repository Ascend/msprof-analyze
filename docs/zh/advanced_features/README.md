...
* msMonitor 采集的集群轻量化 DB 数据，参见《[msMonitor](https://gitcode.com/Ascend/msmonitor/blob/26.1.0/docs/zh/quick_start/msmonitor_quick_start.md)》
...
> [!NOTE]
>
> Ascend 950 系列产品的CCU场景下由于不支持采集通信矩阵和通信算子带宽数据，因此该工具communication_time_sum和communication_matrix_sum分析功能不具有参考意义。
