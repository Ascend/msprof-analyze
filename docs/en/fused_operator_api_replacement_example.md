...
For details about the functions and parameters of TorchNPU APIs, see the [torch_npu APIs](https://gitcode.com/Ascend/op-plugin/blob/26.1.0/docs/en/custom_APIs/torch_npu/torch_npu_list.md).
