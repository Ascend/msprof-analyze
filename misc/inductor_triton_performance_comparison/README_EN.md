...
- The TorchNPU version must be 7.2.0 or later. Supported PyTorch versions are v2.6.0 and v2.7.1. For installation details, see "Installing PyTorch > [Method 1: Offline Installation (Whl)](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/en/installation_guide/installation_via_binary_package.md)" in [Installing Guide](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/en/installation_guide/installation_description.md).
