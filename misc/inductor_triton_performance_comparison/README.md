...
- TorchNPU版本大于等于7.2.0，PyTorch仅支持v2.6.0、v2.7.1，具体安装方式请参见《[TorchNPU软件安装](https://gitcode.com/Ascend/pytorch/blob/v2.7.1/docs/zh/installation_guide/installation_description.md)》的“安装PyTorch > [方式一：离线安装（Whl）](https://gitcode.com/Ascend/pytorch/blob/v2.7.1/docs/zh/installation_guide/installation_via_binary_package.md)”章节。
