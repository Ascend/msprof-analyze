...
- TorchNPU版本大于等于7.2.0，PyTorch版本当前仅支持v2.7.1、2.9.0、2.10.0，具体安装方式请参见《[TorchNPU软件安装](https://gitcode.com/Ascend/pytorch/tree/v2.13.0-26.2.0/docs/zh/installation_guide/building_from_source.md)》。
