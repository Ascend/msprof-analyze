...
For details about other table columns, see the field descriptions when `aic_metrics` is set to `PipeUtilization` in the [op_summary](https://gitcode.com/Ascend/msprof/blob/26.1.0/docs/en/user_guide/profile_data_file_references.md#op_summary-operator-details).
